/*
/////////////////////////////////////////////////////////
CAN Driver/Adatper ver 2.1 (Final)
Author: Grant Lance
Used to initiate two MCP2515 CAN hats on an Arduino UNO.
/////////////////////////////////////////////////////////
All Pins for the MCP2515 are able to be shared except:
- CS pin
- CAN interrupt
For CAN0 CS = digital pin 2 CAN_INT = digital pin 4
For CAN0 CS = digital pin 3 CAN_INT = digital pin 5
For Both:
- VCC Connects to the 5V Pin
- GND Connects to one of the GND pins
- SCK digital pin 13
- SI digital pin 11
- SO digital pin 12
/////////////////////////////////////////////////////////
